...
const OverViewTabComponent = () => {
  const data = {
    ...
    instructor: {
      ...
      desc: "Stephen Grider has been building complex Javascript front ends for top corporations in the San Francisco Bay Area.  With an innate ability to simplify complex topics, Stephen has been mentoring engineers beginning their careers in software development for years, and has now expanded that experience onto KNERD, authoring the highest rated React course. He teaches on KNERD to share the knowledge he has gained with other software engineers.  Invest in yourself by learning from Stephen's published courses.",
    },
  };
      ...
      <div className={css.box1}>
        ...
        <div className={css.sinBox}>
          <div className={css.ttlTxt}>
            Get KNERD certificate by completing entire course
          </div>
          <Button1
            txt="KNERD Certificate"
