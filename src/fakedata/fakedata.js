...
// API_KEY='AIzaSyD8sw3qoVKkzNX19fatQWJs1f5xZOoBDLo';
// const Vid_links =[
//   'https://www.youtube.com/watch?v=QXeEoD0pB3E&list=PLsyeobzWxl7poL9JTVyndKe62ieoN-MZ3&index=1',
//   'https://www.youtube.com/watch?v=hEgO047GxaQ&list=PLsyeobzWxl7poL9JTVyndKe62ieoN-MZ3&index=2',
//   'https://www.youtube.com/watch?v=mbryl4MZJms&list=PLsyeobzWxl7poL9JTVyndKe62ieoN-MZ3&index=3',
//   'https://www.youtube.com/watch?v=DWgzHbglNIo&list=PLsyeobzWxl7poL9JTVyndKe62ieoN-MZ3&index=4',
...
//   'https://www.youtube.com/watch?v=Mf7eFtbVxFM&list=PLsyeobzWxl7poL9JTVyndKe62ieoN-MZ3&index=7'

// ];
// const VIDEO_IDS = Vid_links.map(vid){
//   let url = new URL(vid);
...
const det = {
  ...
  desc: "Instructors from around the world teach millions of students on KNERD. We provide the tools and skills to teach what you love.",
...
const det2 = {
  ttl: "KNERD Bussiness",
  desc: "Get unlimited access to 17,000+ of KNERD’s top courses for your team. Learn and improve skills across business, tech, design, and more.",
  btnTxt: "Get KNERD Business",
  btnLink: "/start-teaching",
  img: showcaseImg2,
  dir: "right",
};
...
const bannerData = [
  ...
  },
  {
    ...
    boxData: {
      ...
      desc: "KNERD Business is trusted by 12.5K+ companies around the world. Find out what we can do for yours.",
    },
  },
  {
    id: 3,
...
const toolsResources = [
  {
    ...
    icon: teachIcon,
    ttl: "Test Video",
    txt: "Get free feedback from KNERD video experts on your audio, video, and delivery.",
  },
  {
    id: "tr-2",
    icon: groupUsersIcon,
    ttl: "Marketplace Insights",
    txt: "Get KNERD-wide market data to create successful courses.",
  },
  {
    id: "tr-3",
    icon: askIcon,
...
const helpResources = [
  {
    ...
    icon: teachIcon,
    ttl: "Teaching Center",
    txt: "Find articles on KNERD teaching — from course creation to marketing.",
  },
  {
    id: "hr-2",
    icon: groupUsersIcon,
